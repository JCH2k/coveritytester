...
# enable using hardware floatingpoint; this is a cortex m4 feature
set( BUERKERT_USE_HARD_FP_ABI ON CACHE BOOL "Using Library for floating point unit." )
if( ${BUERKERT_BUILD_ARCH} STREQUAL "CORTEX_M4" OR ${BUERKERT_BUILD_ARCH} STREQUAL "CORTEX_M7" )
  if( ${BUERKERT_USE_HARD_FP_ABI} )
